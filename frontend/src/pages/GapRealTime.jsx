...
// Real Time
// Real-time bias & misinformation detection across drafts and published content
...
export default function GapRealTime() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Real-time bias & misinformation detection across drafts and published content</p>
