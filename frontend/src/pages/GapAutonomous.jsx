...
// Autonomous
// Autonomous fact-checking engine integrating fact-checking databases
...
export default function GapAutonomous() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Autonomous fact-checking engine integrating fact-checking databases</p>
