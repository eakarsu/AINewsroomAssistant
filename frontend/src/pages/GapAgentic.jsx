...
// Agentic
// Agentic editorial director planning topics + sources + assignments from trends
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic editorial director planning topics + sources + assignments from trends</p>
