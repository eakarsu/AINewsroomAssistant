...
// Streaming
// Streaming source credibility scoring with bias and accuracy history
...
export default function GapStreaming() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Streaming source credibility scoring with bias and accuracy history</p>
